<%@ Page Title="" Language="C#" MasterPageFile="~/HandwritingReader.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HandwritingReader.Login" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                            <asp:Button ID="LoginButton" runat="server" Text="Login" CssClass="btn btn-info" style="margin: auto; display: block; width: 40%;" OnClick="LoginButton_Click"/>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 10px;">
